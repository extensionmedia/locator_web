...
@section('content')
    ...
    <div class="p-4 shadow flex items-center justify-between bg-white rounded m-3 mb-6">
        ...
        <button class="border py-2 px-4 rounded-lg text-sm bg-pink-500 text-white hover:bg-pink-400 focus:outline-none active:bg-pink-600">
    ...
    <div class="p-4 shadow bg-white rounded m-3 mb-6">
        ...
        <div class="flex items-center py-4">
            <button type="submit" class="border py-2 px-4 mr-2 rounded-lg text-sm bg-pink-500 text-white hover:bg-pink-400 focus:outline-none active:bg-pink-600">
